...
Original research code behind three publications on trapped Rydberg atomic ensembles
...
Two earlier papers from the same group — *Trapped Alkali-Metal Rydberg Qubit* (PRL
128, 123601) and *Dynamics of Collective-Dephasing-Induced Multiatom Entanglement*
(PRA 106, L051701) — were also reproduced gate-level in Google Cirq, but that code
lives in a private companion repository rather than here.
